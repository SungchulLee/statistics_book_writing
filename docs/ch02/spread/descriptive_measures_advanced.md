...
??? success "풀이"
    ...
    **왜 하필 $1/n$ 만큼 치우치는가**는 기댓값 계산이 필요하다. $\mathbb{E}[\hat\sigma^2]=\frac{n-1}{n}\sigma^2$ 이므로 편향이 $-\sigma^2/n$ 이라는 것을 [분산추정량](../../ch07/variance/variance_estimators.md) 절에서 증명한다. $\square$
