...
**보기 1.** <span class="diff easy" title="쉬움"></span> 운동, 식습관, 심장질환. 규칙적으로 운동하는 사람($X = 1$)의 심장질환($Y$) 발생률이 낮다고 관측했다고 하자. 그런데 규칙적으로 운동하는 사람은 더 건강한 식습관($Z$)을 갖는 경향도 있다. 식습관은 다음 이유로 교란요인이다:
