...
See: [Survivorship Bias (Wikipedia)](https://en.wikipedia.org/wiki/Survivorship_bias)
...
1. **Include all cases**: Ensure that your analysis includes both successful and failed instances. This might involve looking at historical data, including companies that went bankrupt, or analyzing different segments of the market.
2. **Consider context**: Understand the broader context and potential factors that contribute to both success and failure.
3. **Base rates matter**: Consider how common success is overall. If 90% of startups fail, any shared trait among the 10% that succeed might simply reflect the trait's prevalence in the general population.
...
[연돈볼카츠 제대로 설명드리겠습니다](https://www.youtube.com/watch?v=_jC5OgI7dXk&t=1433s)
