...
**연습문제 2.** <span class="diff easy" title="쉬움"></span> 표준 코시분포(극단적으로 두꺼운 꼬리)에서 크기 40인 세 집단을 생성하라. Bartlett 검정, Brown-Forsythe 검정, Fligner-Killeen 검정을 $\alpha = 0.05$에서 2,000회 반복 적용하여 각각의 거짓 양성률을 보고하라. 어느 검정이 제1종 오류를 가장 잘 조절하는가?
