...
??? success "풀이"
    ...
    다만 "$n > 30$이면 충분하다"는 통상적 기준은 왜도가 심하면 성립하지 않는다. 17장의 [붓스트랩 신뢰구간 시각화](../../ch17/bootstrap_ci/bootstrap_ci_visualization.md) 연습문제 1에서, 왜도가 2인 지수분포에서는 $n = 100$에서도 신뢰구간 포함확률이 $0.934$에 그침을 확인했다.
