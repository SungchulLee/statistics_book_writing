...
??? success "풀이"
    ...
    ```text
    norm:     A^2 = 7.8017   5% critical 0.7720  -> REJECT (모든 수준)
    expon:    A^2 = 0.5851   5% critical 1.3370  -> 기각 못 함 (모든 수준)
    logistic: A^2 = 16.1719  5% critical 0.6590  -> REJECT (모든 수준)
    ```
