...
**연습문제 1.** <span class="diff med" title="중간"></span> Beta-Binomial 켤레 모형에서 출발하여 $a > 1$, $b > 1$일 때 사후최빈값(MAP 추정값)이 다음과 같음을 보여라:
...
**연습문제 4.** <span class="diff med" title="중간"></span> Beta-Binomial 모형에서 $\theta$의 사후분산을 유도하라. $n$이 커질수록 줄어듦을 보이고 그 감소 속도를 해석하라.
