...
Bartlett's test is the uniformly most powerful test when data are truly normal,
but it is highly sensitive to departures from normality.

Usage:
    python bartlett_test.py --seed 1
"""
...
def main():
    parser = argparse.ArgumentParser(description="Bartlett's Test")
